...
public class HttpsClient implements java.io.Serializable {
    ...
    public Response post(String url, String data) throws WeixinException {
        //将JSON数据转换为String字符串
        String dataString = data == null ? "" : data;
        if (Configuration.isDebug()) {
            System.out.println("URL POST 数据：" + dataString);
        }
        //提交数据
        return httpsRequest(url, _POST, dataString, false, null, null, null);
    }
