...
<head>
    ...
    <link rel="${respath}/admin/shortcut icon" href="favicon.ico">
...
<body class="gray-bg">
    <div class="middle-box text-center animated fadeInDown">
        ...
        <div class="error-desc">
            服务器好像出错了...
            <br/>您可以返回主页看看
            <br/><a href="${base}/admin/main/list" class="btn btn-primary m-t">主页</a>
        </div>
    </div>
    <script src="${respath}/admin/js/jquery.min.js?v=2.1.4"></script>
    <script src="${respath}/admin/js/bootstrap.min.js?v=3.3.6"></script>
    <script type="${respath}/admin/text/javascript" src="http://tajs.qq.com/stats?sId=9051096" charset="UTF-8"></script>
</body>
