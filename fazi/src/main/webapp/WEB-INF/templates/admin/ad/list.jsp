...
<html>
	...
	<body class="gray-bg">
		<div class="wrapper wrapper-content  animated fadeInRight">
			<form role="form" class="form-inline" action="${base}/admin/ad/list" method="get">
				<div class="row">
					<div class="ibox">
						<div class="ibox-content">
							...
							<form role="form" class="form-inline">
								...
								<div class="form-group">
									<button onclick="adver_add('添加广告','${base}/admin/ad/add','800','')" type="button" class="btn btn btn-primary">
										<i class="icon iconfont">&#xe614;</i> 添加广告
									</button>
								</div>
							</form>
								...
								<table class="table table-striped table-hover table-bordered">
									...
									<tbody>
										...
										<tr>
											...
											<td>
												<img src="${data.imgUrl}" width="35px" />
											</td>
											<td>
												${data.link}
											</td>
											<td>
												<c:if test="${data.isShow==0}">
													不显示
												</c:if>
												<c:if test="${data.isShow==1}">
													显示
												</c:if>
											</td>
											<td>
											...
											<td>
												<a onclick="adver_add('编辑广告','${base}/admin/ad/edit?id=${data.id}','800','')" class="btn btn-white btn-sm"><i class="icon iconfont">&#xe677;</i> 编辑 </a>
											</td>
										</tr>
										</c:forEach>	
									</tbody>
