	...
	<body>
		<form id="dataForm" class="form-horizontal" style="padding-top: 30px;">
			<div class="form-group">
				...
				<div class="col-sm-8">
					<input id="name" name="name" value="${tag.name}" class="form-control" type="text">
					<input id="id" name="id" value="${tag.id}" class="form-control" type="hidden">
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-8">
					<select class="form-control" name="type" size="1">
						<option <c:if test="${tag.type == 0}">selected="selected"</c:if> value="0">商品标签</option>
						<option <c:if test="${tag.type == 1}">selected="selected"</c:if> value="1">文章标签</option>
					</select>
				</div>
			</div>
			<div class="form-group">
