	...
	<body>
		<form class="form-horizontal" id="dataForm" style="padding-top: 30px;">
			...
			<div class="form-group">
				...
				<div class="col-sm-8">
					<input id="name" name="name" placeholder="请输入等级名称" class="form-control" type="text">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-8">
					<input id="scale" name="scale" placeholder="请输入优惠比例" class="form-control" type="text">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-8">
					<input id="lowAmount" name="lowAmount" placeholder="消费获得最低积分" class="form-control" type="text">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-8">
					<input id="highAmount" name="highAmount" placeholder="消费获得最高积分" class="form-control" type="text">
				</div>
			</div>
		...
		$(function(){
			...
			$("#dataForm").validate({
				...
				submitHandler:function(){
					$.ajax({
						type:"post",
						url:"${base}/admin/member_rank/save",
						dataType:"json",
