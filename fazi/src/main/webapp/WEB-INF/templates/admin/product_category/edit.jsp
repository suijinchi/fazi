	...
	<body>
		<form id="dataForm" class="form-horizontal" style="padding-top: 30px;">
			<div class="form-group">
				...
				<div class="col-sm-8">
					<input id="name" name="name" value="${productCategory.name}" class="form-control" type="text">
					<input id="id" name="id" value="${productCategory.id}" class="form-control" type="hidden">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-8">
					<input class="form-control" type="text" name="indexShowUrl" value="${productCategory.indexShowUrl}" id="indexShowUrl" style="display: inline-block;width: 200px;line-height: 34px;height: 34px;float: left;">
					<label for="file">
			...
			<div class="form-group">
				...
				<div class="col-sm-8">
					<input id="orders" name="orders" value="${productCategory.orders}" class="form-control" type="text">
				</div>
			</div>
			<div class="form-group">
            ...
            $(document).ready(function() {
				...
				$("#dataForm").validate({
					...
					submitHandler:function(form){						
						$.ajax({
							type:"post",
							url:"${base}/admin/productCategory/update",
							dataType:"json",
