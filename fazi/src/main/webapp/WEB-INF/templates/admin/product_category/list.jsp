...
<html>
	...
	<body class="gray-bg">
		<div class="wrapper wrapper-content  animated fadeInRight">
			<form role="form" class="form-inline" action="${base}/admin/productCategory/list" method="get">
				<div class="row">
					<div class="ibox">
						<div class="ibox-content">
							...
							<form role="form" class="form-inline">
								...
								<div class="form-group">
									<button onclick="adver_add('添加分类','${base}/admin/productCategory/add','800','')" type="button" class="btn btn btn-primary">
										<i class="icon iconfont">&#xe614;</i> 添加分类
									</button>
								</div>
							</form>
								...
								<table class="table table-striped table-hover table-bordered">
									...
									<tbody>
										...
										<tr>
											...
											<td>
												<img src="${data.indexShowUrl}" style="max-width: 300px;max-height: 100px">
											</td>
											<td>
												${data.orders}
											</td>
											...
											<td>
												<a onclick="adver_add('编辑分类','${base}/admin/productCategory/edit?id=${data.id}','800','')" class="btn btn-white btn-sm"><i class="icon iconfont">&#xe677;</i> 编辑 </a>
											</td>
										</tr>
										</c:forEach>	
									</tbody>
		...
		<script>
			...
			function admin_del() {
				...
				layer.confirm('确认要删除吗？', function(index) {
					$.ajax({
						type: 'POST',
						url: '${base}/admin/productCategory/delete',
						dataType: 'json',
						data:$ids.serialize(),
