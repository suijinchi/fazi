	...
	<body>
		<form id="dataForm" class="form-horizontal" style="padding-top: 30px;">
			<div class="form-group">
				...
				<div class="col-sm-8">
					<input id="name" name="name" value="${component.name}" class="form-control" type="text">
					<input id="id" name="id" value="${component.id}" class="form-control" type="hidden">
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label"><i class="icon iconfont icon-need">&#xe657;</i>成分图片：</label>
				<div class="col-sm-8">
					<input name="imgUrl" class="form-control" id="imgUrl" value="${component.imgUrl}" readonly="readonly" style="display: inline-block;width:70%;line-height: 34px;height: 34px;float: left;">
			...
			<div id="imgDiv" class="form-group">
				...
				<div class="col-sm-8">
					<img src="${component.imgUrl}" width="100px" />
				</div>
			</div>
			<div class="form-group">
			...
			$(document).ready(function() {
				...
				$("#dataForm").validate({
					...
					submitHandler:function(form){						
						$.ajax({
							type:"post",
							url:"${base}/admin/component/update",
							dataType:"json",
