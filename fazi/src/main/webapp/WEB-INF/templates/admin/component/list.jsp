...
<html>
	...
	<body class="gray-bg">
		<div class="wrapper wrapper-content  animated fadeInRight">
			<form role="form" class="form-inline" action="${base}/admin/component/list" method="get">
				<div class="row">
					<div class="ibox">
						<div class="ibox-content">
							...
							<form role="form" class="form-inline">
								...
								<div class="form-group">
									<button onclick="adver_add('添加成分','${base}/admin/component/add','800','')" type="button" class="btn btn btn-primary">
								...
								<table class="table table-striped table-hover table-bordered">
									...
									<tbody>
										...
										<tr>
											...
											<td>
												<a onclick="adver_add('编辑成分','${base}/admin/component/edit?id=${data.id}','800','')" class="btn btn-white btn-sm"><i class="icon iconfont">&#xe677;</i> 编辑 </a>
											</td>
										</tr>
										</c:forEach>	
									</tbody>
		...
		<script>
			...
			function admin_del() {
				...
				layer.confirm('确认要删除吗？', function(index) {
					$.ajax({
						type: 'POST',
						url: '${base}/admin/component/delete',
						dataType: 'json',
						data:$ids.serialize(),
