...
<form id="dataForm" class="form-horizontal" style="padding-top: 30px;">
	<input type="hidden" name="id" value="${rechargeType.id}" />
	<div class="form-group">
		<label class="col-sm-3 control-label"><i class="icon iconfont icon-need">&#xe657;</i>充值名称：</label>
		<div class="col-sm-8">
			<input id="name" name="name" value="${rechargeType.name}" placeholder="最多12个字符，1个汉字2个字符" class="form-control" type="text">
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-sm-8">
			<input id="amount" name="amount" value="${rechargeType.amount}" class="form-control" type="text">
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-sm-8">
			<input id="giveAmount" name="giveAmount" value="${rechargeType.giveAmount}" class="form-control" type="text">
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-sm-8">
			<input id="orders" name="orders" value="${rechargeType.orders}" class="form-control" type="text">
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-sm-8">
			<label class="checkbox-inline">
				<input name="isShow" type="radio" value="0" <c:if test="${rechargeType.isShow==0}">checked</c:if> id="inlineCheckbox1">否
			</label>
			<label class="checkbox-inline">
				<input name="isShow" type="radio" value="1" <c:if test="${rechargeType.isShow==1}">checked</c:if> id="inlineCheckbox2">是
			</label>
		</div>
	</div>
    ...
    $(document).ready(function() {
        ...
        $("#dataForm").validate({
            ...
            submitHandler:function(form){
                $.ajax({
                    type:"post",
                    url:"${base}/admin/recharge_type/update",
                    dataType:"json",
