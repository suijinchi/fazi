	...
	<body>
		<form id="dataForm" class="form-horizontal" style="padding-top: 30px;">
			...
			<div class="form-group">
				...
				<div class="col-sm-8">
					<select class="form-control" id="articleCategoryId" name="articleCategoryId" size="1">
			...
			<div class="form-group">
				...
				<div class="col-sm-8">
					<input name="showImageUrl" class="form-control" id="imgUrl" readonly="readonly" style="display: inline-block;width:70%;line-height: 34px;height: 34px;float: left;">
			...
			<div class="form-group" id="tagDiv" style="display: block">
				<label class="col-sm-3 control-label">标签：</label>
				<div class="col-sm-9">
					<div class="checkbox i-checks">
						<c:forEach items="${tagList}" var="tag">
							<label><input type="radio" value="${tag.id}" checked="checked" name="tagIds">&nbsp;${tag.name}</label>
						</c:forEach>
					</div>
				</div>
			</div>
				...
				<div class="col-sm-8">
					<div class="checkbox i-checks">
						<label>
							...
							<input id="isPublicationCheck" value="1" type="checkbox"> <i></i> 发布</label>
						<label>
