	...
	<script type="text/javascript">
        $(function() {
            ...
            function loadData(pageNo){
                $.ajax({
                    url:"${base}/mobile/point/listData",
                    data:{
                        pageNo:pageNo
                    },
                    type:"POST",
                    ...
                    success:function(data){
                        ...
                        $.each(data.listData,function(i,n){
                            ...
                            '    			<img class="weui-media-box__thumb" src="${respath}/mobile/images/btn-jj.png" style="width: 80%;margin-top: 6px;">'+
                            '    		</div>'+
                            '    		<div class="weui-media-box__bd">'+
                            '					<h4 class="weui-media-box__title" style="font-size:14px">'+n.memo+'</h4>'+
                            '					<p class="weui-media-box__desc">'+n.createDate+'</p>'+
                            '				</div>'+
                            '				<div class="weui-media-box__hd" style="text-align: center;width: 70px;">'+
							'				<span class="color-danger">'+(n.point>0?('+'+n.point):n.point)+'</span>'+
                            '			</div>'+
                            '   	</a>'+
                            '   </div>'+
                            '</div>';
