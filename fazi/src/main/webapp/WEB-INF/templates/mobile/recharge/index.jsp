...
<section>
	...
	<input type="tel" name="amount" class="otherInp" placeholder="请输入其他充值金额" id="amount" value="" style="display: none"/>
	<div class="weui-cells__title pt pb-5"  style="display: none">其他充值金额(充值金额不小于${setting.minRechargeAmount}元)</div>
