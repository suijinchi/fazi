...
public class RegexUtils {
	...
	/**
	 * 电话号码正则表达式=
	 * (^(\d{2,4}[-_－—]?)?\d{3,8}([-_－—]?\d{3,8})?([-_－—]?\d{1,7})?$)|(^0?1[35]\
	 * d{9}$)
	 */
	...
	public static final String PRICE = "(^[1-9]([0-9]+)?(\\.[0-9]{1,2})?$)|(^(0){1}$)|(^[0-9]\\.[0-9]([0-9])?$)";
	
	/**
	 * 匹配车牌号
	 */
	//https://www.cnblogs.com/jacktang/p/5609931.html
	//public static final String LICENSE_NO = "/^[京津沪渝冀豫云辽黑湘皖鲁新苏浙赣鄂桂甘晋蒙陕吉闽贵粤青藏川宁琼使领A-Z]{1}[A-Z]{1}[A-Z0-9]{4}[A-Z0-9挂学警港澳]{1}$/";
	//http://blog.csdn.net/yuxuac/article/details/52220069
	public static final String LICENSE_NO = "^(([\u4e00-\u9fa5]{1}[A-Z]{1})[-]?|([wW][Jj][\u4e00-\u9fa5]{1}[-]?)|([a-zA-Z]{2}))([A-Za-z0-9]{5}|[DdFf][A-HJ-NP-Za-hj-np-z0-9][0-9]{4}|[0-9]{5}[DdFf])$";
	 ...
	 * @return
	 */
	public static boolean isLICENSE_NO(String str) {
		return Regular(str, LICENSE_NO);
	}
	...
	public static void main(String[] args) {
		/*
		System.out.println(isLICENSE_NO("鲁S14277"));
		System.out.println(isLICENSE_NO("鲁BD14277"));
		System.out.println(isLICENSE_NO("鲁B14277D"));
		*/
