...
public class FreeMarkerUtils {
	...
	public static void main(String[] args) {
		...
		FreeMarkerUtils.initFreeMarker(FreeMarkerUtils.class.getResource("/templates").getPath());  
		Map<String,Object> templateData = new HashMap<String, Object>();  
		templateData.put("name","李广岳");  
		// 生成js文件  
		FreeMarkerUtils.crateFile(templateData, "test.ftl", "D:/mybatis/test.html", true);  
